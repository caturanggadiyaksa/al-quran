...
const BarComp = ({ surah, juz, bookmark }) => {
    return (
        <div className="pt-[4rem] md:pt-[6rem] dark:bg-slate-800">
            <div className="mt-10 mb-4 flex justify-center items-center">
            
                <div className="flex flex-wrap justify-center items-center w-[90%]  min-h-[2.5rem] md:w-[80%] xl:w-2/5 py-6 rounded-full bg-slate-400 text-white text-sm md:text-base sm:py-2">
